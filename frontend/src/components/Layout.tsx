  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="business-card-header bg-gradient-to-r from-gray-50 to-blue-50">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold text-gray-900">PipLinePro</h1>
            <button
              onClick={closeSidebar}
        ...
        <nav className="business-section-tight px-4">
          <div className="space-business-sm">
            {navigation.map((item) => (
              <Link
                ...
                to={item.href}
                onClick={closeSidebar}
                className={`business-nav-item flex items-center gap-3 ${
                  item.current ? 'business-nav-item-active' : 'business-nav-item-inactive'
                }`}
              >
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white shadow-xl">
          ...
          <nav className="flex-1 business-section-tight px-4">
            <div className="space-business-sm">
              {navigation.map((item) => (
                <Link
                  key={item.name}
      ...
      <div className="lg:pl-64">
        {/* Top header */}
        <header className="business-container flex items-center justify-between h-16">
          <div className="flex items-center">
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden p-2.5 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50/30 border border-gray-200/50 hover:border-gray-300/70 transition-all duration-300 hover:shadow-md hover:shadow-gray-200/50 hover:-translate-y-0.5 group"
            >
          ...
          <div className="flex items-center space-business-x-md">
            ...
            <div className="relative notifications-container">
              <button 
                ...
                className="relative p-2.5 text-gray-500 hover:text-gray-700 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50/30 rounded-xl border border-gray-200/50 hover:border-gray-300/70 transition-all duration-300 hover:shadow-md hover:shadow-gray-200/50 hover:-translate-y-0.5 group"
              >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-xl text-gray-700 hover:text-gray-900 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50/30 border border-gray-200/50 hover:border-gray-300/70 transition-all duration-300 hover:shadow-lg hover:shadow-gray-200/50 hover:-translate-y-0.5 group"
              >
                <div className="relative">
                  <div className="w-9 h-9 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-md ring-2 ring-white/20 ring-offset-1 ring-offset-gray-100 group-hover:scale-105 transition-transform duration-300">
              ...
              {userMenuOpen && (
                <div className="business-dropdown">
                  <div className="business-dropdown-item">
                  ...
                  <button
                    ...
                    className="business-dropdown-item w-full text-left"
                  >
