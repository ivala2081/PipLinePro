    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="text-center space-y-4">
          {/* Logo */}
          <div className="mx-auto w-20 h-20 bg-gradient-to-br from-primary to-primary/80 rounded-3xl flex items-center justify-center shadow-xl border border-primary/20">
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <span>{currentTime.toLocaleTimeString(language === 'tr' ? 'tr-TR' : 'en-US')}</span>
            </div>
            <div className="w-px h-4 bg-border" />
            <span>{currentTime.toLocaleDateString(language === 'tr' ? 'tr-TR' : 'en-US')}</span>
          </div>
        </div>
