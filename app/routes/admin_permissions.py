...
@require_main_admin
@handle_errors
@performance_log("admin_section_permissions_view")
...
@require_main_admin
@handle_errors
@performance_log("initialize_section_permissions")
...
@require_main_admin
@handle_errors
@performance_log("update_section_permissions")
...
@require_main_admin
@handle_errors
@performance_log("update_single_section_permission")
...
@require_main_admin
@handle_errors
@performance_log("create_custom_section")
...
@require_main_admin
@handle_errors
@performance_log("delete_section_permission")
...
@login_required
@handle_errors
@performance_log("check_section_access")
...
@login_required
@handle_errors
@performance_log("get_user_accessible_sections")
...
@require_main_admin
@handle_errors
@performance_log("preview_admin_level_sections")
